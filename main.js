...
const routes = [
    {
        ...
        pathMatch: 'full',
        loadChildren: () => __webpack_require__.e(/*! import() | features-currency-converter-currency-converter-module */ "features-currency-converter-currency-converter-module").then(__webpack_require__.bind(null, /*! ./features/currency-converter/currency-converter.module */ "./src/app/features/currency-converter/currency-converter.module.ts")).then(m => m.CurrencyConverterModule)
    },
    {
        path: _constants__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].ROUTES.CURRENCY_CONVERTS_HISTORY.BASE,
        loadChildren: () => __webpack_require__.e(/*! import() | features-currency-converts-history-currency-converts-history-module */ "features-currency-converts-history-currency-converts-history-module").then(__webpack_require__.bind(null, /*! ./features/currency-converts-history/currency-converts-history.module */ "./src/app/features/currency-converts-history/currency-converts-history.module.ts")).then(m => m.CurrencyConvertsHistoryModule)
    },
    { path: '**', redirectTo: '' }
];
...
class ApiService {
    ...
    get(url) {
        return this.httpClient.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["mergeMap"])((result) => {
