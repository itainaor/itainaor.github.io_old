...
const ACTION_INIT_CURRENCIES = 'INIT_CURRENCIES';
const ACTION_SET_FROM_CURRENCY = 'SET_FROM_CURRENCY';
const ACTION_SET_TO_CURRENCY = 'SET_TO_CURRENCY';
...
/* harmony import */ var _app_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app.actions */ "./src/app/core/reducer/app.actions.ts");
...
function reducer(state = initialState, action) {
    switch (action.type) {
        case _app_actions__WEBPACK_IMPORTED_MODULE_0__["ACTION_INIT_CURRENCIES"]:
            return Object.assign(Object.assign({}, state), { currencies: action.payload });
        case _app_actions__WEBPACK_IMPORTED_MODULE_0__["ACTION_SET_FROM_CURRENCY"]:
            return Object.assign(Object.assign({}, state), { fromCurrency: action.payload });
        case _app_actions__WEBPACK_IMPORTED_MODULE_0__["ACTION_SET_TO_CURRENCY"]:
            return Object.assign(Object.assign({}, state), { toCurrency: action.payload });
        default:
...
class CurrencyConverterRoutingModule {
}
...
class CurrencyConverterComponent {
    constructor(requestService, store, toastr, appService) {
    ...
    fetchExchangeRates() {
        this.requestService.getExchangeRates().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])((result) => {
            const currencies = Object.keys(result === null || result === void 0 ? void 0 : result.rates).map((key) => {
                return {
                    name: key,
            ...
            this.store.dispatch({ type: _core_reducer_app_actions__WEBPACK_IMPORTED_MODULE_2__["ACTION_INIT_CURRENCIES"], payload: currencies });
...
/* harmony import */ var _shared_pipes_currency_exchange_pipe__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../shared/pipes/currency-exchange.pipe */ "./src/app/shared/pipes/currency-exchange.pipe.ts");
/* harmony import */ var _core_reducer_app_actions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../core/reducer/app.actions */ "./src/app/core/reducer/app.actions.ts");
...
function CurrencyConverterSearchComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CurrencyConverterSearchComponent_div_0_Template_button_click_17_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11); const ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r10.switchFromTo(); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("formControlName", "amount");
...
class CurrencyConverterSearchComponent {
    constructor(formBuilder, userService, toastr, store) {
        this.formBuilder = formBuilder;
        this.userService = userService;
        this.toastr = toastr;
        this.store = store;
        this.currencyExchangePipe = new _shared_pipes_currency_exchange_pipe__WEBPACK_IMPORTED_MODULE_4__["CurrencyExchangePipe"]();
    }
    ngOnInit() {
        this.stateSubscription = this.userService.getAllStates().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((state) => {
    ...
    addHistory() {
        ...
        if (this.currencyConverterFormGroup.get('amount').value) {
            let currencyConvertsHistory = JSON.parse(localStorage.getItem('currencyConvertsHistory'));
    ...
    initForm() {
        ...
        if (this.initialFromCurrency) {
            ...
            const fromFiltered = this.currencies.filter(currency => currency.name.toLowerCase() === _constants__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].CURRENCY_CONVERTER.DEFAULT_FROM);
        ...
        if (this.initialToCurrency) {
            ...
            const toFiltered = this.currencies.filter(currency => currency.name.toLowerCase() === _constants__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].CURRENCY_CONVERTER.DEFAULT_TO);
        ...
        this.currencyConverterFormGroup.get('from').valueChanges.subscribe((val) => {
            this.store.dispatch({ type: _core_reducer_app_actions__WEBPACK_IMPORTED_MODULE_5__["ACTION_SET_FROM_CURRENCY"], payload: val });
        });
        this.currencyConverterFormGroup.get('to').valueChanges.subscribe((val) => {
            this.store.dispatch({ type: _core_reducer_app_actions__WEBPACK_IMPORTED_MODULE_5__["ACTION_SET_TO_CURRENCY"], payload: val });
        });
    }
    ngOnDestroy() {
...
CurrencyConverterSearchComponent.ɵfac = function CurrencyConverterSearchComponent_Factory(t) { return new (t || CurrencyConverterSearchComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_reducer_user_service__WEBPACK_IMPORTED_MODULE_7__["UserService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ngx_toastr__WEBPACK_IMPORTED_MODULE_8__["ToastrService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ngrx_store__WEBPACK_IMPORTED_MODULE_9__["Store"])); };
CurrencyConverterSearchComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CurrencyConverterSearchComponent, selectors: [["app-currency-converter-search"]], decls: 1, vars: 1, consts: [["class", "currency-converter-search-wrapper", 4, "ngIf"], [1, "currency-converter-search-wrapper"], [3, "formGroup"], [1, "row"], [1, "col-lg"], [1, "form-group"], ["for", "amount"], ["type", "number", "id", "amount", "placeholder", "Enter amount", 1, "form-control", 3, "formControlName"], [1, "form-group", "currency-dropdown"], [3, "formControlName", "clearable", "items", "bindLabel"], ["ng-label-tmp", ""], ["ng-option-tmp", ""], [1, "col-lg", "flex-grow-0", "replace-currencies-button-wrapper"], ["type", "button", 1, "btn", "btn-primary", "replace-currencies-button", 3, "click"], [1, "bi", "bi-arrow-left-right"], [1, "convert-data-outer-wrapper"], [4, "ngIf"], [1, "convert-data-wrapper"], [1, "result"]], template: function CurrencyConverterSearchComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CurrencyConverterSearchComponent, [{
    ...
    }], function () { return [{ type: _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormBuilder"] }, { type: _core_reducer_user_service__WEBPACK_IMPORTED_MODULE_7__["UserService"] }, { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_8__["ToastrService"] }, { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_9__["Store"] }]; }, null); })();
